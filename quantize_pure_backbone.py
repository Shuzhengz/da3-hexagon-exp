...
def main():
    model_in = '/home/ubuntu/da3-npu/models/backbone_pure_static.onnx'
    model_out = '/home/ubuntu/da3-npu/models/backbone_pure_qdq.onnx'
    sample_img = '/home/ubuntu/da3-npu/data/sample.png'

    print(f'Starting QDQ Quantization of {model_in}...')
    t0 = time.time()
